...
public class Constants {
    ...
    public static final String README =
            "Бот позволяет отправить заявку на публикацию твоей истории на канале <a href=\"https://t.me/+qGVq3mfNQrFjOTdi\">СТОП! Кидалово</a>.\n" +
                    "Можно отправить пакет из 5 сообщений не чаще чем 1 раз в час.\n" +
                    "<b>Инструкция по исплозованию бота:</b>\n" +
                    "\n" +
                    "Чтобы начать набирать сообщения, необходимо из меню вызвать команду /begin.\n" +
                    "Далее следует набрать сообщения, которые могут содержать фотографии, видео и просто текст (от 1 до 5).\n" +
                    "Когда будет набрано 5 сообщений, бот сообщит об ограничении, и дальнейшие сообщения будт мгновенно удаляться. Поэтому важно это учитывать и сразу правильно заполнять заявку согласно правилам оформления.\n" +
                    "Набранные в рамках текущей процедуры сообщения допустимо редактировать, однако нельзя удалять, т.к. удаленные собщения бот все равно сохранит и перешлет.\n" +
                    "После того, как будет оформлен пакет сообщений, необходимо из меню вызвать команду /send, после чего весь пакет сообщений будет отправлен менеджеру канала.\n" +
                    "Отправка сообщений автоматически завершит процедуру, и можно будет начать новую выбрав из меню команду /begin. Однако отправка сообщений командой /send будет недоступна в течении 1 часа. При попытке отправить пакет бот будет сообщать об этом и показывать оставшееся время ожидания.\n" +
                    ...
                    "Команда /break позволяет сбросить весь прогресс процедуры, удалить все набранные в рамках текущей процедуры сообщения. Чтобы начать новую процедуру, необходимо из меню вызвать команду /begin.\n" +
                    "\n" +
                    "<b>Правила оформления заявки:</b>";
}
