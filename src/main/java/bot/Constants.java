...
public class Constants {
    ...
    public static final String README =
            "Бот позволяет отправить заявку на публикацию твоей истории на канале [СТОП! Кидалово](https://t.me/+qGVq3mfNQrFjOTdi).\n" +
                    "Можно отправить пакет из 5 сообщений не чаще чем 1 раз в час.\n" +
                    "*bold \\*Инструкция по исплозованию бота:*\n" +
                    "\n" +
                    "1. Чтобы начать набирать сообщения, необходимо из меню вызвать команду /begin.\n" +
                    "2. Далее следует набрать сообщения, которые могут содержать фотографии, видео и просто текст (от 1 до 5).\n" +
                    "3. Когда будет набрано 5 сообщений, бот сообщит об ограничении, и дальнейшие сообщения будт мгновенно удаляться. Поэтому важно это учитывать и сразу правильно заполнять заявку согласно правилам оформления.\n" +
                    "4. Набранные в рамках текущей процедуры сообщения допустимо редактировать, однако нельзя удалять, т.к. удаленные собщения бот все равно сохранит и перешлет.\n" +
                    "5. После того, как будет оформлен пакет сообщений, необходимо из меню вызвать команду /send, после чего весь пакет сообщений будет отправлен менеджеру канала.\n" +
                    "6. Отправка сообщений автоматически завершит процедуру, и можно будет начать новую выбрав из меню команду /begin. Однако отправка сообщений командой /send будет недоступна в течении 1 часа. При попытке отправить пакет бот будет сообщать об этом и показывать оставшееся время ожидания.\n" +
                    "7. Менеджер канала может принять вашу заявку на публикацию, попросить оформить заявку согласно правилам оформления, или отклонить заявку без указания причины.\n" +
                    "8. Команда /break позволяет сбросить весь прогресс процедуры, удалить все набранные в рамках текущей процедуры сообщения. Чтобы начать новую процедуру, необходимо из меню вызвать команду /begin.\n" +
                    "\n" +
                    "*bold \\*Правила оформления заявки:*";
}
